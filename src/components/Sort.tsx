...
import { SortPropertyEnum, setSort } from '../redux/slices/filteredSlice';
...
export default function SortPopup() {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      // console.log(event.originalTarget.offsetParent);
      // console.log(sortRef);
      //@ts-ignore
      if (event.originalTarget.offsetParent !== sortRef.current) {
        setOpen(false);
      }
    };
